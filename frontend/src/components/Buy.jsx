  ...
  return (
    <>
      {error ? (
        ...
        <div className="flex flex-col sm:flex-row my-40  container mx-auto justify-between items-center px-4">
          <div className="w-full md:w-1/2 text-center  sm:text-left">
            <h1 className="text-xl font-semibold  ml-0 sm:ml-[20rem] ">Order Details</h1>
